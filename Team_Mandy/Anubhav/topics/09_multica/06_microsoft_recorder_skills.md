# Experimenting with Microsoft recorder skills
...
> rather than run on a Linux setup — that is flagged where it applies.
...
The interesting question is whether a recording can serve as a skill an agent
invokes. Two workable shapes:
...
**A is more reliable; B is more flexible.** Use A for anything repeated often and B
when the procedure needs judgement at some step.
